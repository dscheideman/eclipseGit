...
public interface BackStepp {
	...
	//if fragment is null, just attempt to find by tag, otherwise replace with passed fragment and assign tag
	Fragment switchFrags(Fragment fragment, String tag);
